...
def ana_frq(cadena, num_let_cad):
    ...
    let_max_frq = ["e", "E", "a", "A", "o", "O", "l", "L", "s", "S", "n", "N", "d"]
    # cadena = cadena.lower()
    lis_clv = []
...
def ejecuta():
    ...
    with open(ruta + "//outputs//archivo_salida_cesar.txt", "r") as archivo_lectura:
        contenido = archivo_lectura.read()  # Leer todo el contenido

    # Paso 2: Llamamos a la función que desencriptará el mensaje
    cad_des_opc = ana_frq(contenido, 10) # El parámetro 5 indica el numero de caracteres más frecuentes
    ...
    try:
        ...
        print("Ejecutado correctamente. Abre el fichero 'archivo_salida_mod.txt'")
    except:
